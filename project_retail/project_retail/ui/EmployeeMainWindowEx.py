...
from project_retail_NTBT.project_retail.project_retail.connectors.employee_connector import EmployeeConnector
from project_retail_NTBT.project_retail.project_retail.models.employee import Employee
from project_retail_NTBT.project_retail.project_retail.ui.EmployeeMainWindow import Ui_MainWindow
...
class EmployeeMainWindowEx(Ui_MainWindow):
    ...
    def insert_data(self):
        ...
        if result > 0:
            ...
            msg.setText("Can not insert a new employee")
